...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_l1a_exe = QtWidgets.QLabel(self.l1a)
        self.lbl_l1a_exe.setObjectName("lbl_l1a_exe")
        self.gridLayout.addWidget(self.lbl_l1a_exe, 1, 0, 1, 1)
        ...
        self.label_2 = QtWidgets.QLabel(self.l1b)
        self.label_2.setObjectName("label_2")
        self.gridLayout_3.addWidget(self.label_2, 3, 0, 1, 1)
        self.label_6 = QtWidgets.QLabel(self.l1b)
        self.label_6.setObjectName("label_6")
        self.gridLayout_3.addWidget(self.label_6, 0, 0, 1, 1)
        self.in_l1b_wd2 = QtWidgets.QLineEdit(self.l1b)
        self.in_l1b_wd2.setObjectName("in_l1b_wd2")
        self.gridLayout_3.addWidget(self.in_l1b_wd2, 3, 1, 1, 1)
        self.in_l1b_exe2 = QtWidgets.QLineEdit(self.l1b)
        self.in_l1b_exe2.setObjectName("in_l1b_exe2")
        self.gridLayout_3.addWidget(self.in_l1b_exe2, 4, 1, 1, 1)
        ...
        self.chk_l1b_script2 = QtWidgets.QCheckBox(self.l1b)
        self.chk_l1b_script2.setObjectName("chk_l1b_script2")
        self.gridLayout_3.addWidget(self.chk_l1b_script2, 5, 0, 1, 1)
        self.btn_l1b_browse2 = QtWidgets.QPushButton(self.l1b)
        self.btn_l1b_browse2.setObjectName("btn_l1b_browse2")
        self.gridLayout_3.addWidget(self.btn_l1b_browse2, 5, 1, 1, 1)
        ...
        self.lbl_l2fb_exe = QtWidgets.QLabel(self.l2fb)
        self.lbl_l2fb_exe.setObjectName("lbl_l2fb_exe")
        self.gridLayout_4.addWidget(self.lbl_l2fb_exe, 1, 0, 1, 1)
        ...
        self.lbl_l2sm_exe = QtWidgets.QLabel(self.l2sm)
        self.lbl_l2sm_exe.setObjectName("lbl_l2sm_exe")
        self.gridLayout_5.addWidget(self.lbl_l2sm_exe, 1, 0, 1, 1)
        ...
        self.lbl_l2si_exe = QtWidgets.QLabel(self.l2si)
        self.lbl_l2si_exe.setObjectName("lbl_l2si_exe")
        self.gridLayout_6.addWidget(self.lbl_l2si_exe, 1, 0, 1, 1)
        ...
        self.lbl_l2ft_exe = QtWidgets.QLabel(self.l2ft)
        self.lbl_l2ft_exe.setObjectName("lbl_l2ft_exe")
        self.gridLayout_7.addWidget(self.lbl_l2ft_exe, 1, 0, 1, 1)
        ...
        self.lbl_pam_exe = QtWidgets.QLabel(self.pam)
        self.lbl_pam_exe.setObjectName("lbl_pam_exe")
        self.gridLayout_8.addWidget(self.lbl_pam_exe, 1, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_save.setText(_translate("MainWindow", "Save and RUN"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.orchestrator), _translate("MainWindow", "Orchestrator"))
        self.lbl_l1a_exe.setText(_translate("MainWindow", "Executable:"))
        ...
        self.label_2.setText(_translate("MainWindow", "Working Directory2:"))
        ...
        self.lbl_l2fb_exe.setText(_translate("MainWindow", "Executable:"))
        ...
        self.lbl_l2sm_exe.setText(_translate("MainWindow", "Executable:"))
        ...
        self.lbl_l2si_exe.setText(_translate("MainWindow", "Executable:"))
        ...
        self.lbl_l2ft_exe.setText(_translate("MainWindow", "Executable:"))
        ...
        self.lbl_pam_exe.setText(_translate("MainWindow", "Executable:"))
